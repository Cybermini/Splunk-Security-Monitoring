# Splunk Security Monitoring — Project Series
...
*Each project includes the full query set, annotated screenshots, and detailed explanations of every SPL command used.*
